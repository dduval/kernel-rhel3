...
sys_create_module(const char *name_user, size_t size)
{
	...
	/* the sii6512 module by accident had an incorrect MODULE_LICENSE; fix that */
	if (strstr(name, "sii6512")) {
		tainted |= 1;
		printk(KERN_ERR "Linking proprietary sii6512 software raid module; tainting kernel\n");
	}
