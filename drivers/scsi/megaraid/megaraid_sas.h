 ...
 */
#define MEGASAS_VERSION				"00.00.02.00-rh1"
#define MEGASAS_RELDATE				"Mar 07, 2007"
#define MEGASAS_EXT_VERSION			"Wed Mar 07 16:12:23 PST 2007"
...
#define DID_IMM_RETRY			DID_SOFT_ERROR
...
#define DMA_64BIT_MASK		0xFFFFFFFFFFFFFFFF
...
#define MEGASAS_IS_LOGICAL(scp)						\
	(scp->channel < MEGASAS_MAX_PD_CHANNELS) ? 0 : 1

#define MEGASAS_DEV_INDEX(inst, scp)					\
	((scp->channel % 2) * MEGASAS_MAX_DEV_PER_CHANNEL) + 		\
	scp->target
